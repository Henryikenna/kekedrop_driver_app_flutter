...
Color backIcon = const Color(0xff000000);
Color underline = const Color(0xff000000).withOpacity(0.3);
Color hintColor = const Color(0xff000000).withOpacity(0.3);
Color inputUnderline = const Color(0xff000000).withOpacity(0.3);
Color inputfocusedUnderline = const Color(0xff000000);
Color topBar = const Color(0xffF8F8F8);
Color page = const Color(0xffF8F8F8);
// Color buttonColor = const Color(0xffFFCC00);
Color buttonColor = const Color(0xffFBB23B);
// Color theme = const Color(0xffFFCC00);
Color theme = const Color(0xffFBB23B);
...
Color loaderColor = const Color(0xffFBB23B);
