...
//base url
String url =
    'https://kekedrop.com/'; //add '/' at the end of the url as 'https://url.com/'
String mapkey =
...
getCountryCode() async {
  ...
  try {
    ...
    // final response = await http.get(Uri.parse('https://restcountries.eu/rest/v2/all'));
...
geolocs.LocationSettings locationSettings = (platform == TargetPlatform.android)
    ? geolocs.AndroidSettings(
        ...
        foregroundNotificationConfig:
          ...
          notificationText:
              "KekeDrop will continue to receive your location in background",
